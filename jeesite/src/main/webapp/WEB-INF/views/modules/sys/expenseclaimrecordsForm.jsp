...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/expenseclaimrecords/">报销表列表</a></li>
		<li class="active"><a href="${ctx}/sys/expenseclaimrecords/form?id=${expenseclaimrecords.id}">报销表<shiro:hasPermission name="sys:expenseclaimrecords:edit">${not empty expenseclaimrecords.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:expenseclaimrecords:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
