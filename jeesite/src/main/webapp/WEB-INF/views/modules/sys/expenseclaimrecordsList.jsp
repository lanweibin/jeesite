...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/expenseclaimrecords/">报销表列表</a></li>
		<shiro:hasPermission name="sys:expenseclaimrecords:edit"><li><a href="${ctx}/sys/expenseclaimrecords/form">报销表添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="expenseclaimrecords">
			<tr>
				...
				<shiro:hasPermission name="sys:expenseclaimrecords:edit"><td>
					...
					<a href="${ctx}/sys/expenseclaimrecords/delete?id=${expenseclaimrecords.id}" onclick="return confirmx('确认要删除该报销表吗？', this.href)">删除</a>
